...
\begin{minipage}{0.38\textwidth}
 Although the uniform chemical forcing dominates in this case, the influence of the heat flux pattern is clearly visible in the surface projection of the radial magnetic field component in figure \ref{fig:surface_Br_d20}. Patches of concentrated magnetic field lie at  $\sim$45$^\circ$ and $225^\circ$ in both, the northern and the southern hemisphere. They are each shifted $45^\circ$ west of the longitudes of maximum heat flux ($90^\circ$ and $270^\circ$, see figure \ref{fig:fluxsketch}). In section \ref{sec:attached_columns}, the flow convergence and divergence
\end{minipage}
\hfill
\begin{minipage}{0.59\textwidth}
  \includegraphics[width = \textwidth]{graphs/dynamo/flux_patches_d20_2.png}
  \caption{Hammer-Aitov surface projection of the radial magnetic field near the CMB at $r=1.485$. Two patches of high intensity magnetic field are located at $\sim$45$^\circ$ and $225^\circ$ in the northern and the southern hemisphere.}
  \label{fig:surface_Br_d20}
\end{minipage}
\end{figure} \noindent
at the top of anticyclones and cyclones, respectively, controls the surface distribution of the chemical component (see figure \ref{fig:vort_chem}). In a comparable way, magnetic field is intensified and weakened by cyclonic and anticyclonic motion at the CMB. A necessary condition for this process to happen can be understood in the framework \textit{Alfv\'{e}n's theorem} that states:\\ \par
...
This means that the relative importance of magnetic diffusion in the induction equation (the second term on the rhs of \eqref{eq:induction^}) decides whether flow convergence and divergence can serve as an explanation for the flux patches. The \textit{magnetic Reynolds number} estimates the ratio of inertia and magnetic diffusion and therefore is the relevant quantity in this context. 
