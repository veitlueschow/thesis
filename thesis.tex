...
\begin{figure}[t]
\centering
      \includegraphics[width = 0.8\textwidth]{graphs/dynamo/flux_patches_d20_2.png}
...
\end{figure} \noindent
In section \ref{sec:attached_columns}, the flow convergence and divergence at the top of anticyclones and cyclones, respectively, controls the surface distribution of the chemical component (see figure \ref{fig:vort_chem}). In a comparable way, magnetic field is intensified and weakened by cyclonic and anticyclonic motion at the CMB. A necessary condition for this process to happen can be understood in the framework \textit{Alfv\'{e}n's theorem} that states:\\ \par
...
This means that the relative importance of magnetic diffusion in the induction equation (the second term on the rhs of \eqref{eq:induction^}) decides whether flow convergence and divergence can serve as an explanation for the flux patches. The \textit{magnetic Reynolds number} estimates the ratio of magnetic advection and induction to magnetic diffusion and therefore is the relevant quantity in this context \citep{christensen2011geodynamo}.
...
\hfill
\begin{minipage}{0.47\textwidth}
 \includegraphics[width = 0.95\textwidth]{graphs/dynamo/dyn_d20_vectorfield_Br.png}
 \caption{...}
