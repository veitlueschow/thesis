...
\begin{equation*}
T_\textrm{cond}(r,\vartheta,\varphi) = t_0^0(r) + t_2^2(r,\vartheta,\varphi),
\end{equation*}
where $t_0^0(r)$ is proportional to the constant $\mathcal{Y}_0^0$ and $t_2^2(r)$ to $\mathcal{Y}_2^2(\vartheta, \varphi)$ that is a function of $\vartheta$ and $\varphi$. \\
...
\end{equation*}
since this would demand $\partial \tau/\partial \vartheta = \partial \tau/\partial \varphi = 0$, a condition that cannot be fulfilled by $t_2^2$ being a function of $\vartheta$ and $\varphi$. Thus, $t^2_2$ appears in the buoyancy term of the momentum equation:
\begin{align}
\nonumber
