...
\end{figure} \noindent
The goal of this section is to integrate the findings of section \ref{sec:dyn_d020} concerning the magnetic flux patch generation into the context of the changing driving mechanism discussed in section \ref{sec:delta_dependence}. It was already shown that the effect of the heat flux pattern persists even if the relative influence of the thermal driving component makes up only 12\%. A justification for the choice of PFF12 as a showcase in the above section will be given and the relation between the corresponding effect and the changing of the forcing ratio clarified. \\ \par \noindent
...
The behavior of the Elsasser number (representative for the magnetic field strength) when changing $\delta^*$, shown in figure \ref{fig:els_reym}(a), allows two more observations: (a) The standard deviation of the temporal averages increases with increasing $\delta^*$ for case PFF and UFF. (b) The magnetic energy is higher for the heterogeneous case PFF (black line) than for the uniform case UFF (red line). \\
