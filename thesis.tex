...
On the other hand, \citet{breuer2010thermochemically} report an increase of the kinetic energy similarly, if the low Prandtl number forcing gains control. Their model contains Derichlet BC in both forcing components. 
