...
\\
In order to implement the BC into the numerics, a (conductive) solution to \eqref{eq:laplace} has to be found. In the most general form, it reads
\begin{equation}
